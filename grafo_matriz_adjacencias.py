...
def geraGrafoCompleto10():
    ...
    grafo.adicionaVertice("Rimnicu Vilcea")
    ...
    grafo.adicionaAresta("Arad", "Rimnicu Vilcea", 80 )
    ...
    grafo.adicionaAresta("Zerind", "Rimnicu Vilcea", 80 )
    ...
    grafo.adicionaAresta("Oradea", "Rimnicu Vilcea", 151 )
    ...
    grafo.adicionaAresta("Sibiu", "Rimnicu Vilcea", 80 )
    ...
    grafo.adicionaAresta("Fagaras", "Rimnicu Vilcea", 80 )
    ...
    grafo.adicionaAresta("Rimnicu Vilcea", "Pitesti", 97 )
    grafo.adicionaAresta("Rimnicu Vilcea", "Timisoara", 118 )
    grafo.adicionaAresta("Rimnicu Vilcea", "Lugoj", 111 )
    grafo.adicionaAresta("Rimnicu Vilcea", "Mehadia", 70 )
...
# retorna uma lista de 11 elementos aleatórios com as cidades de Arad, Zerind, Oradea, Sibiu, Fagaras, Rimnicu Vilcea, Pitesti, Timisoara, Lugoj, Mehadia
# sendo o ultimo elemento e o primeiro tem que ser igual a alguma cidade definida pelo parametro passado
    lista = ["Arad", "Zerind", "Oradea", "Sibiu", "Fagaras", "Rimnicu Vilcea", "Pitesti", "Timisoara", "Lugoj", "Mehadia"]  
